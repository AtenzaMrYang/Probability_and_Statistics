...
\begin{solution}
    ...
    $$
        \overline{X} \sim N\left(\mu, \frac{\sigma^2}{n}\right) = N\left(12, (\sqrt{0.8})^2\right).
    $$
    样本均值与总体均值之差的绝对值大于 1 的概率
    $$
        \begin{aligned}
            P\{|\overline{X} - \mu| > 1\}
             & = 1 - P\left\{\left|\overline{X} - \mu\right| \leqslant 1 \right\}                                                         \\
             & = 1 - P\left\{-1 \leqslant \overline{X}-12 \leqslant 1\right\}                                                             \\
