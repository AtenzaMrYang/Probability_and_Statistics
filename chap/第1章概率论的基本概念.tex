...
\begin{solution}
    \begin{itemize}
        \item[(1)] $A\overline{B}\overline{C}$
        \item[(2)] $AB\overline{C}$
        \item[(3)] $A \cup B \cup C$
        \item[(4)] $ABC$
        \item[(5)] $\overline{A}\overline{B}\overline{C}$
        \item[(6)] $\overline{A}\overline{B}\overline{C} \cup A\overline{B}\overline{C} \cup \overline{A}B\overline{C} \cup \overline{A}\overline{B}C$
...
\begin{question}{题目3}
    \begin{itemize}
        \item [(1)] 设 $A,B,C$ 是三个事件，且 $P(A) = P(B) = P(C) = \frac{1}{4}$，$P(AB) = P(BC) = 0$，$P(AC) = \frac{1}{8}$，求 $A,B,C$ 至少有一个发生的概率.

        \item [(2)] 已知 $P(A) = \frac{1}{2}$，$P(B) = \frac{1}{3}$，$P(C) = \frac{1}{5}$，$P(AB) = \frac{1}{10}$，$P(AC) = \frac{1}{15}$，$P(BC) = \frac{1}{20}$，$P(ABC) = \frac{1}{30}$，求 $A \cup B$，$\bar{A}\bar{B}$，$A \cup B \cup C$，$\bar{A}\bar{B}\bar{C}$，$\bar{A}\bar{B}C$，$\bar{A} \bar{B}\cup C$ 的概率.

        \item [(3)] 已知 $P(A) = \frac{1}{2}$，(i)若 $A,B$ 互不相容，求$P(A\bar{B})$，(ii)若$P(AB) = \frac{1}{8}$，求 $P(A\bar{B})$.
    \end{itemize}
\end{question}
\begin{solution}
    (1) 根据多个事件的加法公式
    ...
    $$
        \begin{aligned}
            P(\bar{A}\bar{B}C)
            = P\left(\bar{A}\bar{B}(S-\bar{C})\right)
            = P\left(\bar{A}\bar{B}\right) - P\left(\bar{A}\bar{B}\bar{C}\right)
            = \frac{4}{15} - \frac{3}{20}
            = \frac{7}{60}.
        \end{aligned}
    $$
    ...
    $$
        \begin{aligned}
            P\left( (\bar{A}\bar{B})\cup C \right)
            = P(\bar{A}\bar{B}) + P(C) - P(\bar{A}\bar{B}C)
