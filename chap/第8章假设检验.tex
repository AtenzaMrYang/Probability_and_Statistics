...
\begin{solution}
    ...
    当 $\alpha_2 = 0.01$ 时
    $$
        C_2 = \left\{|z| \geqslant z_{0.005}\right\} = \{|z| \geqslant 2.58\}.
    $$
    \paragraph{第四步} 代入实测值
    $$
...
\begin{solution}
    ...
    $$
        ...
        = \left\{\frac{\bar{x}-\mu_0}{\sigma/\sqrt{n}} \leqslant -z_{\alpha}\right\}
        = \{z \leqslant -z_{0.05}\}
        = \{z \leqslant -1.645\}.
    $$
    \paragraph{第四步} 代入实测值
    $$
        z = \frac{928-950}{10/\sqrt{9}} = -6.6 \in C.
    $$
...
\begin{solution}
    ...
    $$
        ...
        = \left\{\frac{\bar{x}-\mu_0}{\sigma/\sqrt{n}} \geqslant z_{\alpha}\right\}
        = \{z \geqslant z_{0.05}\}
        = \{z \geqslant 1.645\}.
    $$
    \paragraph{第四步} 代入实测值
...
\begin{solution}
    ...
    $$
        ...
        = \{t \leqslant -4.60413\} \cup \{t \geqslant 4.60413\}.
    $$
    \paragraph{第四步} 代入实测值 $\bar{x}=3.252$，$S=0.013$
    $$
        t = \frac{3.252-3.25}{0.013/\sqrt{5}} = 0.344 \notin C.
    $$
...
\begin{solution}
    ...
    $$
        ...
        = \left\{\frac{\bar{x}-\mu_0}{S/\sqrt{n}}<-t_{\alpha}(n-1)\right\}
        = \{t<-t_{0.05}(16)\}
        = \{t<-1.7459\}.
    $$
...
\begin{solution}
    ...
    $$
        ...
        = \left\{\frac{\bar{x}-\mu_0}{S/\sqrt{n}} \geqslant t_{\alpha}(n-1)\right\}
...
\begin{solution}
    ...
    $$
    故 $\alpha = 0.02$ 的情况下拒绝 $H_0$，认为这批电池的寿命的波动性较以往的有显著的变化.
\end{solution}
...
\begin{solution}
    ...
    $$
    故 $\alpha = 0.01$ 的情况下拒绝 $H_0$，认为提纯后群体比原群体更整齐.
\end{solution}
...
\begin{solution}
    ...
    \paragraph{第一步} 作统计假设
    $$
        H_0: \sigma^2 \leqslant \sigma_0^2 = 0.005^2, \quad H_1: \sigma^2 > \sigma_0^2 = 0.005^2.
    $$
    \paragraph{第二步} 选取检验统计量
    $$
        \chi^2 = \frac{(n-1)S^2}{\sigma_0^2}.
