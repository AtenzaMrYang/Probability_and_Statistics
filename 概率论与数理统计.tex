...
\maketitle
\tableofcontents
\input{chap/第1章概率论的基本概念.tex}
\input{chap/第2章随机变量及其分布.tex}
\input{chap/第3章多维随机变量及其分布.tex}
\input{chap/第4章随机变量的数字特征.tex}
% 第5章大数定律与中心极限定理，并不属于本校的教学内容
\input{chap/第6章样本及抽样分布.tex}
\input{chap/第7章参数估计.tex}
\input{chap/第8章假设检验.tex}
\input{exam/概率论与数理统计期中考试.tex}
\end{document}